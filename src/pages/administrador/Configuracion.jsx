  ...
  useEffect(() => {
    ...
    (async function () {
      try {
        ...
        setRole(
          data.role === "ADMIN" ? "Administrador" : data.role === "TECH" ? "Técnico" : "Cliente"
        );
            ...
            <div className="space-y-4">
              ...
              <div className="pt-2">
                <button
                  ...
                  disabled={isLoading}
                  className="w-full px-4 py-2 bg-teal-600 text-white rounded-lg hover:bg-teal-700 transition-colors font-medium disabled:bg-gray-400 disabled:cursor-not-allowed flex items-center justify-center gap-2"
                >
                  {isLoading ? (
                    <>
            ...
            <div className="space-y-6">
              ...
              <div>
                ...
                <div className="space-y-3">
                  {[
                    { key: "solicitudes", label: "Solicitudes de cambio de estado" },
                    { key: "alertas", label: "Alertas de sobreocupación" },
                    { key: "tickets", label: "Tickets finalizados" },
                  ].map((n) => (
                    <div key={n.key} className="flex items-center justify-between">
                      ...
                      <button
                        ...
                        className={`relative inline-flex h-6 w-11 items-center rounded-full transition-colors ${
                          notifications[n.key] ? "bg-teal-600" : "bg-gray-200"
                        }`}
                      >
                        <span
              ...
              <div className="space-y-4">
                  ...
                  {passwords.new && (
                    <div className="mt-2 space-y-2">
                      <div className="flex gap-1">
                        <div className={`h-2 flex-1 rounded-full ${passwordStrength?.metCriteria >= 1 ? (passwordStrength?.strength === "weak" ? "bg-red-500" : passwordStrength?.strength === "medium" ? "bg-yellow-500" : "bg-green-500") : "bg-gray-200"}`} />
                        <div className={`h-2 flex-1 rounded-full ${passwordStrength?.metCriteria >= 3 ? (passwordStrength?.strength === "medium" ? "bg-yellow-500" : passwordStrength?.strength === "strong" ? "bg-green-500" : "bg-gray-200") : "bg-gray-200"}`} />
                        <div className={`h-2 flex-1 rounded-full ${passwordStrength?.strength === "strong" ? "bg-green-500" : "bg-gray-200"}`} />
                      </div>
                ...
                <div className="flex gap-3 pt-2">
                  <button
                    ...
                    className="flex-1 px-4 py-2 bg-teal-600 text-white rounded-lg hover:bg-teal-700 transition-colors font-medium disabled:bg-gray-400 disabled:cursor-not-allowed flex items-center justify-center gap-2"
                  >
                    {isLoadingPassword ? (
                      <>
                        <svg className="animate-spin h-5 w-5" viewBox="0 0 24 24">
                  ...
                  <button
                    ...
                    disabled={isLoadingPassword}
                    className="flex-1 px-4 py-2 bg-transparent border border-gray-300 text-gray-700 rounded-lg hover:bg-gray-50 transition-colors font-medium disabled:opacity-50 disabled:cursor-not-allowed"
                  >
                    Cancelar
                  </button>
                </div>
